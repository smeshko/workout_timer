...
public extension PreviewProvider {
    static var mockExercise1: Exercise {
        Exercise(id: "mock-exercise-1", name: "Mock Exercise 1", image: "preview-exercise-1")
    }

    static var mockExercise2: Exercise {
        Exercise(id: "mock-exercise-2", name: "Mock Exercise 2", image: "preview-exercise-2")
    }

    static var mockExercise3: Exercise {
        Exercise(id: "mock-exercise-3", name: "Mock Exercise 3", image: "preview-exercise-3")
    }

    static var mockWorkout1: Workout {
        Workout(id: "mock-workout-1", name: "Mock Workout 1", image: "preview-exercise-4", sets: [
